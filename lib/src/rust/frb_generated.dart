...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -32998711;
...
abstract class RustLibApi extends BaseApi {
  bool crateUaStringIsEmpty({required UaString that});

  bool crateUaStringIsNull({required UaString that});

  PlatformInt64 crateUaStringLen({required UaString that});

  UaString crateUaStringNull();

  void crateUaStringSetValue({required UaString that, String? value});
  ...
  Future<StatusCode> crateApiMinimalWrapSessionEventLoopRun(
      {required WrapSessionEventLoop that});

  Future<JoinHandleStatusCode> crateApiMinimalWrapSessionEventLoopSpawn(
      {required WrapSessionEventLoop that});

  Future<List<WrapMonitoredItemCreateResult>>
      crateApiMinimalWrapSessionCreateMonitoredItems(
  ...
  WrapMonitoredItemCreateRequest
      crateApiTypesMonitoredItemCreateRequestWrapMonitoredItemCreateRequestFrom(
          {required WrapNodeId value});

  Future<void>
      crateApiTypesMonitoredItemCreateRequestWrapmonitoreditemcreaterequest(
          {required WrapMonitoredItemCreateRequest a});

  int crateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetMonitoredItemId(
      {required WrapMonitoredItemCreateResult that});

  int crateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetRevisedQueueSize(
      {required WrapMonitoredItemCreateResult that});

  double
      crateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetRevisedSamplingInterval(
          {required WrapMonitoredItemCreateResult that});

  StatusCode
      crateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetStatusCode(
          {required WrapMonitoredItemCreateResult that});

  void
      crateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorSetMonitoredItemId(
          {required WrapMonitoredItemCreateResult that,
          required int monitoredItemId});

  void
      crateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorSetRevisedQueueSize(
          {required WrapMonitoredItemCreateResult that,
          required int revisedQueueSize});

  void
      crateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorSetRevisedSamplingInterval(
          {required WrapMonitoredItemCreateResult that,
          required double revisedSamplingInterval});

  void
      crateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorSetStatusCode(
          {required WrapMonitoredItemCreateResult that,
  ...
  WrapNodeId crateApiTypesNodeIdWrapNodeIdNew(
      {required int namespace, required WrapIdentifier value});
  ...
  WrapMonitoredItemCreateRequest
      crateApiTypesNodeIdWrapNodeIdToMonitoredItemCreateRequest(
          {required WrapNodeId that});
  ...
  int crateApiTypesStatusCodeStatusCodeBits({required StatusCode that});

  bool crateApiTypesStatusCodeStatusCodeIsBad({required StatusCode that});

  bool crateApiTypesStatusCodeStatusCodeIsGood({required StatusCode that});

  bool crateApiTypesStatusCodeStatusCodeIsUncertain({required StatusCode that});
  ...
  WrapUaString crateApiTypesStringWrapUaStringNew({required String value});
  ...
  Future<void> crateApiTypesWriteValueWrapbytestring({required ByteString a});

  Future<void> crateApiTypesWriteValueWrapguid({required Guid a});

  Future<void> crateApiTypesWriteValueWrapidetifier({required Identifier a});

  Future<void> crateApiTypesWriteValueWrapnodeid({required NodeId a});

  Future<void> crateApiTypesWriteValueWrapuastring({required UaString a});

  Future<void> crateApiTypesWriteValueWrapwritevalue({required WriteValue a});
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_Identifier;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_Identifier;
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_WrapMonitoredItemCreateResult;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_WrapMonitoredItemCreateResult;

  CrossPlatformFinalizerArg
      get rust_arc_decrement_strong_count_WrapMonitoredItemCreateResultPtr;
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_WriteValue;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_WriteValue;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  bool crateUaStringIsEmpty({required UaString that}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateUaStringIsEmptyConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateUaStringIsEmptyConstMeta => const TaskConstMeta(
  ...
  bool crateUaStringIsNull({required UaString that}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateUaStringIsNullConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateUaStringIsNullConstMeta => const TaskConstMeta(
  ...
  PlatformInt64 crateUaStringLen({required UaString that}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateUaStringLenConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateUaStringLenConstMeta => const TaskConstMeta(
  ...
  UaString crateUaStringNull() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateUaStringNullConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateUaStringNullConstMeta => const TaskConstMeta(
  ...
  void crateUaStringSetValue({required UaString that, String? value}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateUaStringSetValueConstMeta,
      argValues: [that, value],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateUaStringSetValueConstMeta => const TaskConstMeta(
        debugName: "UaString_set_value",
        argNames: ["that", "value"],
      );
  ...
  Future<List<WrapMonitoredItemCreateResult>>
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiMinimalWrapSessionCreateMonitoredItemsConstMeta,
      argValues: [that, subscriptionId, timestampsToReturn, itemsToCreate],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMinimalWrapSessionCreateMonitoredItemsConstMeta =>
      const TaskConstMeta(
        debugName: "WrapSession_create_monitored_items",
        argNames: [
          "that",
          "subscriptionId",
          "timestampsToReturn",
  ...
  WrapMonitoredItemCreateRequest
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiTypesMonitoredItemCreateRequestWrapMonitoredItemCreateRequestFromConstMeta,
      argValues: [value],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiTypesMonitoredItemCreateRequestWrapMonitoredItemCreateRequestFromConstMeta =>
          const TaskConstMeta(
            debugName: "WrapMonitoredItemCreateRequest_from",
            argNames: ["value"],
          );
  ...
  int crateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetMonitoredItemId(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetMonitoredItemIdConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetMonitoredItemIdConstMeta =>
          const TaskConstMeta(
            debugName:
                "WrapMonitoredItemCreateResult_auto_accessor_get_monitored_item_id",
            argNames: ["that"],
          );
  ...
  int crateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetRevisedQueueSize(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetRevisedQueueSizeConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetRevisedQueueSizeConstMeta =>
          const TaskConstMeta(
            debugName:
                "WrapMonitoredItemCreateResult_auto_accessor_get_revised_queue_size",
            argNames: ["that"],
          );
  ...
  double
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetRevisedSamplingIntervalConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetRevisedSamplingIntervalConstMeta =>
          const TaskConstMeta(
            debugName:
                "WrapMonitoredItemCreateResult_auto_accessor_get_revised_sampling_interval",
            argNames: ["that"],
          );
  ...
  StatusCode
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetStatusCodeConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetStatusCodeConstMeta =>
          const TaskConstMeta(
            debugName:
                "WrapMonitoredItemCreateResult_auto_accessor_get_status_code",
            argNames: ["that"],
          );
  ...
  void
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorSetMonitoredItemIdConstMeta,
  ...
  TaskConstMeta
      get kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorSetMonitoredItemIdConstMeta =>
          const TaskConstMeta(
            debugName:
                "WrapMonitoredItemCreateResult_auto_accessor_set_monitored_item_id",
  ...
  void
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorSetRevisedQueueSizeConstMeta,
  ...
  TaskConstMeta
      get kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorSetRevisedQueueSizeConstMeta =>
          const TaskConstMeta(
            debugName:
                "WrapMonitoredItemCreateResult_auto_accessor_set_revised_queue_size",
  ...
  void
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorSetRevisedSamplingIntervalConstMeta,
  ...
  TaskConstMeta
      get kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorSetRevisedSamplingIntervalConstMeta =>
          const TaskConstMeta(
            debugName:
                "WrapMonitoredItemCreateResult_auto_accessor_set_revised_sampling_interval",
  ...
  void
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorSetStatusCodeConstMeta,
  ...
  TaskConstMeta
      get kCrateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorSetStatusCodeConstMeta =>
          const TaskConstMeta(
            debugName:
                "WrapMonitoredItemCreateResult_auto_accessor_set_status_code",
  ...
  WrapNodeId crateApiTypesNodeIdWrapNodeIdNew(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        sse_encode_box_autoadd_wrap_identifier(value, serializer);
      ...
      constMeta: kCrateApiTypesNodeIdWrapNodeIdNewConstMeta,
      argValues: [namespace, value],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesNodeIdWrapNodeIdNewConstMeta =>
      const TaskConstMeta(
        debugName: "WrapNodeId_new",
  ...
  WrapMonitoredItemCreateRequest
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiTypesNodeIdWrapNodeIdToMonitoredItemCreateRequestConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiTypesNodeIdWrapNodeIdToMonitoredItemCreateRequestConstMeta =>
          const TaskConstMeta(
            debugName: "WrapNodeId_to_monitored_item_create_request",
            argNames: ["that"],
          );
  ...
  int crateApiTypesStatusCodeStatusCodeBits({required StatusCode that}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiTypesStatusCodeStatusCodeBitsConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesStatusCodeStatusCodeBitsConstMeta =>
      const TaskConstMeta(
        debugName: "StatusCode_bits",
        argNames: ["that"],
      );
  ...
  bool crateApiTypesStatusCodeStatusCodeIsBad({required StatusCode that}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiTypesStatusCodeStatusCodeIsBadConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesStatusCodeStatusCodeIsBadConstMeta =>
      const TaskConstMeta(
        debugName: "StatusCode_is_bad",
        argNames: ["that"],
      );
  ...
  bool crateApiTypesStatusCodeStatusCodeIsGood({required StatusCode that}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiTypesStatusCodeStatusCodeIsGoodConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesStatusCodeStatusCodeIsGoodConstMeta =>
      const TaskConstMeta(
        debugName: "StatusCode_is_good",
        argNames: ["that"],
      );

  @override
  bool crateApiTypesStatusCodeStatusCodeIsUncertain(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiTypesStatusCodeStatusCodeIsUncertainConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesStatusCodeStatusCodeIsUncertainConstMeta =>
      const TaskConstMeta(
        debugName: "StatusCode_is_uncertain",
        argNames: ["that"],
      );
  ...
  WrapUaString crateApiTypesStringWrapUaStringNew({required String value}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiTypesStringWrapUaStringNewConstMeta,
      argValues: [value],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesStringWrapUaStringNewConstMeta =>
      const TaskConstMeta(
        debugName: "WrapUaString_new",
        argNames: ["value"],
      );
  ...
  Future<void> crateApiTypesWriteValueWrapbytestring({required ByteString a}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiTypesWriteValueWrapbytestringConstMeta,
      argValues: [a],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesWriteValueWrapbytestringConstMeta =>
      const TaskConstMeta(
        debugName: "_wrapbytestring",
        argNames: ["a"],
      );
  ...
  Future<void> crateApiTypesWriteValueWrapguid({required Guid a}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiTypesWriteValueWrapguidConstMeta,
      argValues: [a],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesWriteValueWrapguidConstMeta =>
      const TaskConstMeta(
        debugName: "_wrapguid",
        argNames: ["a"],
      );
  ...
  Future<void> crateApiTypesWriteValueWrapidetifier({required Identifier a}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiTypesWriteValueWrapidetifierConstMeta,
      argValues: [a],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesWriteValueWrapidetifierConstMeta =>
      const TaskConstMeta(
        debugName: "_wrapidetifier",
        argNames: ["a"],
      );
  ...
  Future<void> crateApiTypesWriteValueWrapnodeid({required NodeId a}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiTypesWriteValueWrapnodeidConstMeta,
      argValues: [a],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesWriteValueWrapnodeidConstMeta =>
      const TaskConstMeta(
        debugName: "_wrapnodeid",
        argNames: ["a"],
      );
  ...
  Future<void> crateApiTypesWriteValueWrapuastring({required UaString a}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiTypesWriteValueWrapuastringConstMeta,
      argValues: [a],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesWriteValueWrapuastringConstMeta =>
      const TaskConstMeta(
        debugName: "_wrapuastring",
        argNames: ["a"],
      );
  ...
  Future<void> crateApiTypesWriteValueWrapwritevalue({required WriteValue a}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiTypesWriteValueWrapwritevalueConstMeta,
      argValues: [a],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesWriteValueWrapwritevalueConstMeta =>
      const TaskConstMeta(
        debugName: "_wrapwritevalue",
        argNames: ["a"],
      );
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_WrapMonitoredItemCreateResult => wire
  ...
  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_WrapMonitoredItemCreateResult => wire
  ...
  Identifier
      dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerIdentifier(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return IdentifierImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  WrapMonitoredItemCreateResult
      dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWrapMonitoredItemCreateResult(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return WrapMonitoredItemCreateResultImpl.frbInternalDcoDecode(
        raw as List<dynamic>);
  }
  ...
  WriteValue
      dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWriteValue(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return WriteValueImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  UaString
      dco_decode_box_autoadd_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUAString(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUAString(
        raw);
  }
  ...
  Identifier
      sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerIdentifier(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return IdentifierImpl.frbInternalSseDecode(
        sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  }
  ...
  WrapMonitoredItemCreateResult
      sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWrapMonitoredItemCreateResult(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return WrapMonitoredItemCreateResultImpl.frbInternalSseDecode(
        sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  }
  ...
  WriteValue
      sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWriteValue(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return WriteValueImpl.frbInternalSseDecode(
        sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  }
  ...
  UaString
      sse_decode_box_autoadd_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUAString(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUAString(
        deserializer));
  }
  ...
  List<WrapMonitoredItemCreateRequest>
    ...
    var ans_ = <WrapMonitoredItemCreateRequest>[];
  ...
  List<WrapMonitoredItemCreateResult>
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <WrapMonitoredItemCreateResult>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(
          sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWrapMonitoredItemCreateResult(
              deserializer));
  ...
  UaString?
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUAString(
          deserializer));
    } else {
      return null;
    }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as GuidImpl).frbInternalSseEncode(move: true), serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as IdentifierImpl).frbInternalSseEncode(move: true), serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as WrapMonitoredItemCreateResultImpl)
            .frbInternalSseEncode(move: true),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as WriteValueImpl).frbInternalSseEncode(move: true), serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as StatusCodeImpl).frbInternalSseEncode(move: false), serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as GuidImpl).frbInternalSseEncode(move: null), serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as IdentifierImpl).frbInternalSseEncode(move: null), serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as WriteValueImpl).frbInternalSseEncode(move: null), serializer);
  }
...
@sealed
class IdentifierImpl extends RustOpaque implements Identifier {
  // Not to be used by end users
  IdentifierImpl.frbInternalDcoDecode(List<dynamic> wire)
      : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  IdentifierImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
      : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_Identifier,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_Identifier,
    rustArcDecrementStrongCountPtr:
        RustLib.instance.api.rust_arc_decrement_strong_count_IdentifierPtr,
  );
}
...
class StatusCodeImpl extends RustOpaque implements StatusCode {
  ...
  int bits() => RustLib.instance.api.crateApiTypesStatusCodeStatusCodeBits(
        that: this,
      );

  bool isBad() => RustLib.instance.api.crateApiTypesStatusCodeStatusCodeIsBad(
        that: this,
      );

  bool isGood() => RustLib.instance.api.crateApiTypesStatusCodeStatusCodeIsGood(
        that: this,
      );

  bool isUncertain() =>
      RustLib.instance.api.crateApiTypesStatusCodeStatusCodeIsUncertain(
        that: this,
      );
}
...
class UaStringImpl extends RustOpaque implements UaString {
  ...
  bool isEmpty() => RustLib.instance.api.crateUaStringIsEmpty(
        that: this,
      );

  bool isNull() => RustLib.instance.api.crateUaStringIsNull(
        that: this,
      );

  PlatformInt64 len() => RustLib.instance.api.crateUaStringLen(
        that: this,
      );

  void setValue({String? value}) =>
      RustLib.instance.api.crateUaStringSetValue(that: this, value: value);
}
...
@sealed
class WrapMonitoredItemCreateResultImpl extends RustOpaque
    implements WrapMonitoredItemCreateResult {
  // Not to be used by end users
  WrapMonitoredItemCreateResultImpl.frbInternalDcoDecode(List<dynamic> wire)
      : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  WrapMonitoredItemCreateResultImpl.frbInternalSseDecode(
      BigInt ptr, int externalSizeOnNative)
      : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib.instance.api
        .rust_arc_increment_strong_count_WrapMonitoredItemCreateResult,
    rustArcDecrementStrongCount: RustLib.instance.api
        .rust_arc_decrement_strong_count_WrapMonitoredItemCreateResult,
    rustArcDecrementStrongCountPtr: RustLib.instance.api
        .rust_arc_decrement_strong_count_WrapMonitoredItemCreateResultPtr,
  );

  int get monitoredItemId => RustLib.instance.api
          .crateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetMonitoredItemId(
        that: this,
      );

  int get revisedQueueSize => RustLib.instance.api
          .crateApiTypesMonitoredItemCreateResultWrapMonitoredItemCreateResultAutoAccessorGetRevisedQueueSize(
        that: this,
      );
...
class WrapSessionImpl extends RustOpaque implements WrapSession {
  ...
  Future<List<WrapMonitoredItemCreateResult>> createMonitoredItems(
          ...
          required TimestampsToReturn timestampsToReturn,
          required List<WrapMonitoredItemCreateRequest> itemsToCreate}) =>
      RustLib.instance.api.crateApiMinimalWrapSessionCreateMonitoredItems(
          that: this,
...
@sealed
class WriteValueImpl extends RustOpaque implements WriteValue {
  // Not to be used by end users
  WriteValueImpl.frbInternalDcoDecode(List<dynamic> wire)
      : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  WriteValueImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
      : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_WriteValue,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_WriteValue,
    rustArcDecrementStrongCountPtr:
        RustLib.instance.api.rust_arc_decrement_strong_count_WriteValuePtr,
  );
}
